...
class ComparisonEventTest extends OrmFunctionalTestCase
{
    ...
    public function testListenerShouldBeNotifierComputeChangeSet(): void
    {
    ...
    public function testListenerShouldBeNotifierRecomputeChangeSet(): void
    {
        $user = $this->createNewValidUser();
        $this->_em->persist($user);
        $this->_em->flush();
...
class ComparisonListener
{
    ...
    public function onComparison(OnComparisonEventArgs $args): void
    {
